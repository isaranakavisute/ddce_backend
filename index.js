       ...
       else
       {
          var wb = new Excel.Workbook();
                    ...
                    rows.map((row) => {
                          ...
                          sql += value ? (row.getCell(1).result != '') ? row.getCell(1).result : ''  : row.getCell(1).value ? row.getCell(1).value : '';

                          sql += "','";
                          value = row.getCell(2).formula;
                          sql += value ? (row.getCell(2).result != '') ? row.getCell(2).result : ''  : row.getCell(2).value ? row.getCell(2).value : '';

                          sql += "','";
                          value = row.getCell(3).formula;
                          sql += value ? (row.getCell(3).result != '') ? row.getCell(3).result : ''  : row.getCell(3).value ? row.getCell(3).value : '';

                          sql += "','";
                          value = row.getCell(4).formula;
                          sql += value ? (row.getCell(4).result != '') ? row.getCell(4).result : ''  : row.getCell(4).value ? row.getCell(4).value : '';

                          sql += "','";
                          value = row.getCell(5).formula;
                          sql += value ? (row.getCell(5).result != '') ? row.getCell(5).result : ''  : row.getCell(5).value ? row.getCell(5).value : '';

                          sql += "','";
                          value = row.getCell(6).formula;
                          sql += value ? (row.getCell(6).result != '') ? row.getCell(6).result : ''  : row.getCell(6).value ? row.getCell(6).value : '';

                          sql += "','";
                          value = row.getCell(7).formula;
                          sql += value ? (row.getCell(7).result != '') ? row.getCell(7).result : ''  : row.getCell(7).value ? row.getCell(7).value : '';

                          sql += "','";
                          value = row.getCell(8).formula;
                          sql += value ? (row.getCell(8).result != '') ? row.getCell(8).result : ''  : row.getCell(8).value ? row.getCell(8).value : '';

                          sql += "','";
                          value = row.getCell(9).formula;
                          sql += value ? (row.getCell(9).result != '') ? row.getCell(9).result : ''  : row.getCell(9).value ? row.getCell(9).value : '';

                          sql += "','";
                          value = row.getCell(10).formula;
                          sql += value ? (row.getCell(10).result != '') ? row.getCell(10).result : ''  : row.getCell(10).value ? row.getCell(10).value : '';

                          sql += "','";
                          value = row.getCell(11).formula;
                          sql += value ? (row.getCell(11).result != '') ? row.getCell(11).result : ''  : row.getCell(11).value ? row.getCell(11).value : '';

                          sql += "','";
                          value = row.getCell(12).formula;
                          sql += value ? (row.getCell(12).result != '') ? row.getCell(12).result : ''  : row.getCell(12).value ? row.getCell(12).value : '';

                          sql += "','";
                          value = row.getCell(13).formula;
                          sql += value ? (row.getCell(13).result != '') ? row.getCell(13).result : ''  : row.getCell(13).value ? row.getCell(13).value : '';

                          sql += "','";
                          value = row.getCell(14).formula;
                          sql += value ? (row.getCell(14).result != '') ? row.getCell(14).result : ''  : row.getCell(14).value ? row.getCell(14).value : '';

                          sql += "','";
                          value = row.getCell(15).formula;
                          sql += value ? (row.getCell(15).result != '') ? row.getCell(15).result : ''  : row.getCell(15).value ? row.getCell(15).value : '';

                          sql += "','";
                          value = row.getCell(16).formula;
                          sql += value ? (row.getCell(16).result != '') ? row.getCell(16).result : ''  : row.getCell(16).value ? row.getCell(16).value : '';

                          sql += "','";
                          value = row.getCell(17).formula;
                          sql += value ? (row.getCell(17).result != '') ? row.getCell(17).result : ''  : row.getCell(17).value ? row.getCell(17).value : '';

                          sql += "','";
                          value = row.getCell(18).formula;
                          sql += value ? (row.getCell(18).result != '') ? row.getCell(18).result : ''  : row.getCell(18).value ? row.getCell(18).value : '';

                          sql += "','";
                          value = row.getCell(19).formula;
                          sql += value ? (row.getCell(19).result != '') ? row.getCell(19).result : ''  : row.getCell(19).value ? row.getCell(19).value : '';

                          sql += "','";
                          value = row.getCell(20).formula;
                          sql += value ? (row.getCell(20).result != '') ? row.getCell(20).result : ''  : row.getCell(20).value ? row.getCell(20).value : '';

                          sql += "','";
                          value = row.getCell(21).formula;
                          sql += value ? (row.getCell(21).result != '') ? row.getCell(21).result : ''  : row.getCell(21).value ? row.getCell(21).value : '';

                          sql += "','";
                          value = row.getCell(22).formula;
                          sql += value ? (row.getCell(22).result != '') ? row.getCell(22).result : ''  : row.getCell(22).value ? row.getCell(22).value : '';

                          sql += "','";
                          value = row.getCell(23).formula;
                          sql += value ? (row.getCell(23).result != '') ? row.getCell(23).result : ''  : row.getCell(23).value ? row.getCell(23).value : '';

                          sql += "','";
                          value = row.getCell(24).formula;
                          sql += value ? (row.getCell(24).result != '') ? row.getCell(24).result : ''  : row.getCell(24).value ? row.getCell(24).value : '';

                          sql += "','";
                          value = row.getCell(25).formula;
                          sql += value ? (row.getCell(25).result != '') ? row.getCell(25).result : ''  : row.getCell(25).value ? row.getCell(25).value : '';

                          sql += "','";
                          value = row.getCell(26).formula;
                          sql += value ? (row.getCell(26).result != '') ? row.getCell(26).result : ''  : row.getCell(26).value ? row.getCell(26).value : '';

                          sql += "','";
                          value = row.getCell(27).formula;
                          sql += value ? (row.getCell(27).result != '') ? row.getCell(27).result : ''  : row.getCell(27).value ? row.getCell(27).value : '';

                          sql += "','";
                          value = row.getCell(28).formula;
                          sql += value ? (row.getCell(28).result != '') ? row.getCell(28).result : ''  : row.getCell(28).value ? row.getCell(28).value : '';

                          sql += "','";
                          value = row.getCell(29).formula;
                          sql += value ? (row.getCell(29).result != '') ? row.getCell(29).result : ''  : row.getCell(29).value ? row.getCell(29).value : '';

                          sql += "','";
                          value = row.getCell(30).formula;
                          sql += value ? (row.getCell(30).result != '') ? row.getCell(30).result : ''  : row.getCell(30).value ? row.getCell(30).value : '';

                          sql += "','";
                          value = row.getCell(31).formula;
                          sql += value ? (row.getCell(31).result != '') ? row.getCell(31).result : ''  : row.getCell(31).value ? row.getCell(31).value : '';
